<ContentWithSidebar>
    <div class="sidebar" slot="sidebar">
        ...
        <textarea bind:value={_rawItems} placeholder="2 3 4 1 0 2 1 8 11 9"></textarea>
        <div class="spacer-s"> </div>
        <div class="subnote">e.g. <ClickToCopy><code>85 70 36 75 53 73 1 4 94 29</code></ClickToCopy></div>
        <div class="spacer-l"> </div>
        <button class="submit-button button-submit" on:click={onSubmit}>SORT</button>
    </div>
    <div class="output flex-col flex-cross-center">
        {#if items}
